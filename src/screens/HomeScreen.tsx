        ...
        <View style={styles.section}>
          ...
          <View style={styles.actionsGrid}>
            ...
            <TouchableOpacity style={styles.actionCard}>
              ...
              >
                <Icon name="barbell" size={32} color="#ffffff" />
            ...
            <TouchableOpacity style={styles.actionCard}>
              ...
              >
                <Icon name="stats-chart" size={32} color="#ffffff" />
        ...
        <View style={styles.section}>
          ...
          <View style={styles.goalsCard}>
            <View style={styles.goalItem}>
              <Icon name="water" size={20} color={theme.primary} />
              <Text style={styles.goalText}>Drink 2000ml of water</Text>
              <Icon
                name={waterConsumed >= waterGoal ? 'checkmark-circle' : 'ellipse-outline'}
                size={20}
                color={waterConsumed >= waterGoal ? '#10b981' : theme.textTertiary}
              />
            </View>
            ...
            <View style={styles.goalItem}>
              ...
              <Icon name="ellipse-outline" size={20} color={theme.textTertiary} />
            </View>
